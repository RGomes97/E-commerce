...
<div class="row topos">
	...
	<div class="col s12 m12 l3 colunaesq z-depth-2">
     ...
     <h4 style="background-color: #1abc9c; color: white; border-radius: 20px;"> Folhetos </h4>
     </div>
	<div class="col s12 m12 l9">
	<?php
		if($return == null){
			echo '<center>Ainda não temos Folhetos no site, mas em breve teremos!</center>';
		}
		foreach($return as $value){
			...
			echo '<div id="imagem">';
			echo '<center><img src="img/folheto.jpg"></center>';
			echo '</div>';
			echo '</div>';
			...
			echo '<center><a href="prodFolheto.php?prod='.$value['id'].'" class="btn waves-effect waves "><i class="material-icons right">shopping_cart</i> Add +</a>
